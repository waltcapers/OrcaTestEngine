 ...
 *
 * A [ScriptResult] is produced by all implementations of [orca.engine.core.ScriptHandler] and
 ...
 * ```
 *
 * These metrics are aggregated globally by [orca.engine.core.OrcaEngine] and can be used as:
...
data class ScriptResult(
    ...
    val stdout: String,
    val stderr: String,
    val metrics: Map<String, Double> = Collections.emptyMap()
)